<template>
  <div>
    <Head title="青涩校园" :show="false" :hidden="true"></Head>
    <Ad></Ad>
    <div class="classify" v-if="flag">
      <ul>
        <li @click="gotoDetail(item._id)" v-for="(item,i) in XiaoYuan" :key="i">
          <div class="left">
...
export default {
  ...
  created() {
    ...
    this.$http.get("http://localhost:1810/vue/typeXiaoYuan").then(res => {
      // console.log(res);
